...
export function Logo() {
  return (
    <Link href="/dashboard" aria-label="PonCoins home" className="group inline-flex cursor-pointer items-center gap-3 rounded-xl focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring">
